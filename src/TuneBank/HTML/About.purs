...
about =
  HH.div
    [ HP.id "aboutdiv" ]
    [ HH.h2_
        [ HH.text "TradTuneDb version 2.0.0" ]
    , HH.p_
       [ HH.text $
         ("TradTuneDb is a database of Irish, Scottish, Scandinavian and klezmer tunes. You can search for tunes and then view the scores " <>
